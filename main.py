...
initial_folder = "/discover/nobackup/vmarchai/experiments/init-c48"
...
run_file = f"{experiment_folder}/gcm_run.j"
list_of_vars = ['prog.eta']
heart_beat = 450
cap_restart_file = f"{experiment_folder}/cap_restart"
...
if __name__ == '__main__':
    ...
    print("## Run Model")
    run_model.main(agcm_nophysic_path, run_file, False)
    print('## Save files')
    ...
    restart_folder.main(experiment_folder, initial_folder)
    print("## Run Model")
    run_model.main(agcm_physic_path,  run_file, True)
    print('## Save files')
